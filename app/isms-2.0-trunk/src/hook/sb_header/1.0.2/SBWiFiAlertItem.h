...
- (BOOL)allowMenuButtonDismissal;	// IMP=0x00068360
- (void)configure:(BOOL)fp8 requirePasscodeForActions:(BOOL)fp12;	// IMP=0x000687d0
- (void)dealloc;	// IMP=0x000680e0
- (id)deletionSetForLostNetworks:(id)fp8 originalNetworks:(id)fp12;	// IMP=0x00067038
- (void)didDeactivate:(BOOL)fp8;	// IMP=0x00068a20
- (void)didPresentAlertSheet:(id)fp8;	// IMP=0x00067e64
- (void)dismiss;	// IMP=0x00067938
- (BOOL)dismissOnLock;	// IMP=0x00068a18
- (id)init;	// IMP=0x00066bb0
- (id)insertionsForNewNetworks:(id)fp8;	// IMP=0x00066ef0
...
- (void)tableSelectionDidChange:(id)fp8;	// IMP=0x00068460
